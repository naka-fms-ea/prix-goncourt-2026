...
class PublisherDao(Dao[Publisher]):
    def create(self, publisher: Publisher) -> int:
        """Crée en BD l'entité Publisher correspondant au éditeur publisher

        :param publisher: à créer sous forme d'entité publisher en BD
        :return: l'id de l'entité insérée en BD (0 si la création a échoué)
        """

        with Dao.connection.cursor() as cursor:
            sql = "INSERT INTO pg_editeur (ed_nom_editeur) VALUES (%s)"
